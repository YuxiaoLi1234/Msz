...
parallel -j1 'export CUDA_VISIBLE_DEVICE=$(({%}-1)); ./helloworld {1} {2} {3} 0;' ::: "at,177,95,48" "heated,150,450,1" "CSEM,1800,3600,1"  :::: bounds.txt ::: sz3 zfp
parallel -j1 'export CUDA_VISIBLE_DEVICE=$(({%}-1)); ./helloworld {1} {2} {3} 0;' ::: "jet_cropped,100,100,100" ::: 1e-2 ::: sz3 zfp
